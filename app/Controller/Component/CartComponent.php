...
//////////////////////////////////////////////////
    ...
    public function add($id, $quantity = 1, $productmodId = null,  $product_size = null, $product_color = null, $order_po = null) {
	...
	//	if($product['Product']['discounted_price'] > 0) {
				...
				if($product['Product']['discounted_price'] != '0.00') {

				
        $data['price'] = $product['Product']['discounted_price'];
		}
		else {
