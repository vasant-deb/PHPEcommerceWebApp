...
<section class="about-page section-b-space">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="banner-section"><img src="images/sitepages/<?php echo $page['Sitepage']['image']; ?>" class="img-fluid blur-up lazyload" alt=""></div>
            </div>
            <div class="col-sm-12">
                <h4><?php echo $page['Sitepage']['short_description']; ?></h4>
                <p><?php echo $page['Sitepage']['description']; ?></p>
                    ...
                    <div>
                        <div class="media">
                            <div class="text-center">
                                <img src="images/testimonials/<?php echo $testimonial['Testimonial']['image'];?>" alt="#">
                                <h5><?php echo $testimonial['Testimonial']['name'];?></h5>
                                <h6><?php echo $testimonial['Testimonial']['designation'];?></h6>
                            </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="team-4">
                    <div>
                        <div>
                            <img src="digikart/assets/images/team/1.jpg" class="img-fluid blur-up lazyload bg-img" alt="">
                        </div>
                        <h4>Hileri Keol</h4>
                    ...
                    <div>
                        <div>
                            <img src="digikart/assets/images/team/2.jpg" class="img-fluid blur-up lazyload bg-img" alt="">
                        </div>
                        <h4>Hileri Keol</h4>
                        <h6>CEo & Founder At Company</h6>
                    </div>
                    <div>
                        <div>
                            <img src="digikart/assets/images/team/3.jpg" class="img-fluid blur-up lazyload bg-img" alt="">
                        </div>
                        <h4>Hileri Keol</h4>
                        <h6>CEo & Founder At Company</h6>
                    </div>
                    <div>
                        <div>
                            <img src="digikart/assets/images/team/4.jpg" class="img-fluid blur-up lazyload bg-img" alt="">
                        </div>
                        <h4>Hileri Keol</h4>
                        <h6>CEo & Founder At Company</h6>
                    </div>
