  ...
  <div class="row">
    <div class="col-lg-12">
      <div class="widget-container fluid-height clearfix">
        <div class="heading"> <i class="fa fa-table"></i>Manage Sizes
          <?php 
		   echo $this->Html->link("<i class=\"fa fa-plus\"></i>New Size",
...
<?php echo $this->Form->postLink("<i class=\"fa fa-trash\"></i>", array('action' => 'delete', $item['Size']['id']), array('escape' => FALSE,'class' => 'table-actions'), __('Are you sure you want to delete # %s?', $item['Size']['id'])); ?>
