...
var maxprice_value = inputMax.value;
			...
			xpricefilter(minprice_value,maxprice); 
	}
...
<script type="text/javascript">
		...
		function Xpricefilter(minprice_value,maxprice_value) {
			 			
						
                           $.ajax({   

                                url: "categories/pricedata",  

                                async: false,

                                type: "POST",  

                               data: "minprice_value="+minprice_value+"&maxprice_value="+maxprice_value,                          
