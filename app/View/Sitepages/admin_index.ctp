  ...
  <div class="row">
    <div class="col-lg-12">
      <div class="widget-container fluid-height clearfix">
        <div class="heading"> <i class="fa fa-table"></i>Manage Sitepages
          <?php 
		   echo $this->Html->link("<i class=\"fa fa-plus\"></i>New Sitepage",
          ...
          <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
			...
			<?php foreach ($pages as $page): ?>
              <tr>
				...
				<!--
				<a href="<?php echo $this->webroot;?><?php echo $page['Sitepage']['slug'];?>" target="_blank" class="table-actions"><i class="fa fa-eye-open"></i></a>	
				-->
