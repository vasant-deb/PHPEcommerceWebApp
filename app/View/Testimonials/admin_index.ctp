  ...
  <div class="row">
    <div class="col-lg-12">
      <div class="widget-container fluid-height clearfix">
        <div class="heading"> <i class="fa fa-table"></i>Manage Testimonials
          <?php 
		   echo $this->Html->link("<i class=\"fa fa-plus\"></i>New Testimonial",
...
<?php echo $this->Form->postLink("<i class=\"fa fa-trash\"></i>", array('action' => 'delete', $item['Testimonial']['id']), array('escape' => FALSE,'class' => 'table-actions'), __('Are you sure you want to delete # %s?', $item['Testimonial']['id'])); ?>
