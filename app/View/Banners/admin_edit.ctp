          ...
          ?>
              ...
              <div class="form-group">
			   ...
			   <div class="form-group">
				...
				$thumbImageurl = $this->Html->url('/images/banners/'.$this->data['Banner']['image']);
				$Imageurl = "http://www.placehold.it/200x150/EFEFEF/AAAAAA&amp;text=no+image";
				
				$Imageurl = ($this->data['Banner']['image'] != '')?$thumbImageurl:$Imageurl;
				?>
...
<div class="form-group">
                ...
                <div class="col-md-4">
                  <div class="fileupload fileupload-new" data-provides="fileupload">
                    <div class="fileupload-new img-thumbnail"> <img src="<?php echo $Imageurl;?>" class="img-responsive"> </div>
