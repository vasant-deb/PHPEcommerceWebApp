  ...
  <div class="row">
    <div class="col-lg-12">
      <div class="widget-container fluid-height clearfix">
        <div class="heading"> <i class="fa fa-table"></i>Manage Products
          <?php 
		   echo $this->Html->link("<i class=\"fa fa-plus\"></i>New Product",
        ...
        <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
			...
			<a href="<?php echo $this->webroot;?>admin/productphotos/index/<?php echo $product['Product']['id'];?>" class="table-actions"><i class="fa fa-camera"></i></a>
