        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="page-title">
                    <h2><?php echo $product['Product']['name']; ?></h2></div>
            </div>
            <div class="col-sm-6">
                <nav aria-label="breadcrumb" class="theme-breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="<?php echo $this->webroot; ?>">Home</a></li>
                        <li class="breadcrumb-item active"><a href="products.html">product</a></li>
						<li class="breadcrumb-item active" aria-current="page"><?php echo $product['Product']['name']; ?></li>
                    </ol>
                </nav>
            </div>
        </div>
                ...
                <div class="col-sm-3 collection-filter">
                    ...
                    <div class="theme-card">
                        ...
                        <div class="offer-slider slide-1">
                            <div>
                                <div class="media">
                                    <a href="#"><img class="img-fluid blur-up lazyload" src="digikart/assets/images/pro/1.jpg" alt=""></a>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="product-slick">
								 <?php $i  =0;
foreach($product['Productphoto'] as $gallery):

			  ?>
                                    <div><img src="images/productphotos/<?php echo $gallery['image']; ?>" alt="" class="img-fluid blur-up lazyload image_zoom_cls-<?php echo $i ; ?>"></div>
                                    <?php $i++; endforeach; ?>
                                </div>
                                <div class="row">
...
foreach($product['Productphoto'] as $gallery):
			  ...
			  ?>
                                            <div><img src="images/productphotos/<?php echo $gallery['image']; ?>" alt="" class="img-fluid blur-up lazyload"></div>
                                              <?php $i++; endforeach; ?>
                                        </div>
                                    </div>
                                </div>
			...
			<?php  echo $this->Form->input('id', array('type' => 'hidden', 'value' => $product['Product']['id'])); ?>
                                    ...
                                    <h4><del>$<?php echo $product['Product']['price']; ?></del><span>55% off</span></h4>
                                    <h3>$<?php echo $product['Product']['discounted_price']; ?></h3>
                                    <select name="data[Product][product_color]"  required>
					 <option value="" required>Select Color</option>
                    <?php 
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel"><?php echo $product['Product']['name']; ?></h5>
                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                    </div>
                                                    <div class="modal-body"><img src="digikart/assets/images/size-chart.jpg" alt="" class="img-fluid blur-up lazyload"></div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="size-box">
                                            <select name="data[Product][product_size]" required>
					 <option value="" required>Select Size</option>
                     <?php 	
                              foreach ($sizes as $size_item):  	
                              ?>  
                                                <option class="text-right c-price text-defualt text-center" value="<?php echo h($size_item['Size']['name']); ?>" ><?php echo h($size_item['Size']['name']); ?></option>
                                               <?php 
                              endforeach;
                              ?>
                    </select>
                                        ...
                                        <div class="qty-box">
                                          <div class="input-group"><span class="input-group-prepend"><button type="button" class="btn quantity-left-minus" data-type="minus" data-field=""><i class="ti-angle-left"></i></button> </span>
                                                <input type="text" name="data[Product][quantity]" class="form-control input-number" value="1"> <span class="input-group-prepend"><button type="button" class="btn quantity-right-plus" data-type="plus" data-field=""><i class="ti-angle-right"></i></button></span></div>            
                                    ...
                                    <div class="product-buttons"> <a ><?php echo $this->Form->button('Add to Cart', array( 'id' => 'addtocart','class' => 'btn btn-solid' , 'id' => $product['Product']['id']));?></a>
									<a href="#" class="btn btn-solid">buy now</a></div>
                                ...
                                <div class="tab-content nav-material" id="top-tabContent">
                                    ...
                                    <div class="tab-pane fade" id="top-profile" role="tabpanel" aria-labelledby="profile-top-tab">
										...
										<div class="single-product-tables">
                                            <table>
                                                <tbody>
												  <?php if($product['Product']['fit'] !='') { ?>
                                                <tr>
                                                    <td>Compositions</td>
                                                    <td><?php echo $product['Product']['fit']; ?></td>
                                                </tr>
													<?php } ?>
                    <?php if($product['Product']['style'] !='') { ?>
                                                <tr>
                                                    <td>Style</td>
                                                     <td><?php echo $product['Product']['style']; ?></td>
                                                </tr><?php }?>
												 <?php if($product['Product']['length'] !='') { ?>
                                                <tr>
                                                    <td>Properties</td>
        ...
        <div class="row search-product">
            <div class="col-xl-2 col-md-4 col-sm-6">
                <div class="product-box">
                    <div class="img-wrapper">
                        <div class="front">
                            <a href="#"><img src="digikart/assets/images/pro3/33.jpg" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                        </div>
                        <div class="back">
                            <a href="#"><img src="digikart/assets/images/pro3/34.jpg" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                        </div>
            ...
            <div class="col-xl-2 col-md-4 col-sm-6">
                <div class="product-box">
                    <div class="img-wrapper">
                        <div class="front">
                            <a href="#"><img src="digikart/assets/images/pro3/1.jpg" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                        </div>
                        <div class="back">
                            <a href="#"><img src="digikart/assets/images/pro3/2.jpg" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                        </div>
                        <div class="cart-info cart-wrap">
                            <button data-toggle="modal" data-target="#addtocart"  title="Add to cart"><i class="ti-shopping-cart" ></i></button> <a href="javascript:void(0)" title="Add to Wishlist"><i class="ti-heart" aria-hidden="true"></i></a> <a href="#" data-toggle="modal" data-target="#quick-view" title="Quick View"><i class="ti-search" aria-hidden="true"></i></a> <a href="compare.html" title="Compare"><i class="ti-reload" aria-hidden="true"></i></a></div>
                    </div>
            ...
            <div class="col-xl-2 col-md-4 col-sm-6">
                <div class="product-box">
                    <div class="img-wrapper">
                        <div class="front">
                            <a href="#"><img src="digikart/assets/images/pro3/27.jpg" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                        </div>
                        <div class="back">
                            <a href="#"><img src="digikart/assets/images/pro3/28.jpg" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                        </div>
                        <div class="cart-info cart-wrap">
                            <button data-toggle="modal" data-target="#addtocart"  title="Add to cart"><i class="ti-shopping-cart" ></i></button> <a href="javascript:void(0)" title="Add to Wishlist"><i class="ti-heart" aria-hidden="true"></i></a> <a href="#" data-toggle="modal" data-target="#quick-view" title="Quick View"><i class="ti-search" aria-hidden="true"></i></a> <a href="compare.html" title="Compare"><i class="ti-reload" aria-hidden="true"></i></a></div>
                    </div>
            ...
            <div class="col-xl-2 col-md-4 col-sm-6">
                <div class="product-box">
                    <div class="img-wrapper">
                        <div class="front">
                            <a href="#"><img src="digikart/assets/images/pro3/35.jpg" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                        </div>
                        <div class="back">
                            <a href="#"><img src="digikart/assets/images/pro3/36.jpg" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                        </div>
                        <div class="cart-info cart-wrap">
                            <button data-toggle="modal" data-target="#addtocart"  title="Add to cart"><i class="ti-shopping-cart" ></i></button> <a href="javascript:void(0)" title="Add to Wishlist"><i class="ti-heart" aria-hidden="true"></i></a> <a href="#" data-toggle="modal" data-target="#quick-view" title="Quick View"><i class="ti-search" aria-hidden="true"></i></a> <a href="compare.html" title="Compare"><i class="ti-reload" aria-hidden="true"></i></a></div>
                    </div>
